...
def main():
    ...
    while True:
        ...
        if hasLowerCase(phrase):
            print(f'{phrase} has a lower case character')
        else:
            print(f'{phrase} has no lower case character')

        # FIXME4 #fixed#
        # print if the phrase has a digit by calling the proper function
        if hasDigit(phrase):
            print(f'{phrase} has a digit character')
        else:
            print(f'{phrase} has no digit character')

        # FIXME5 #fixed#
        # print if the phrase has a symbol by calling the proper function
        if hasSymbol(phrase):
            print(f'{phrase} as an ascii character')
        else:
            print(f'{phrase} has no ascii character')
